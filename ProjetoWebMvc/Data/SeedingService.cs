...
namespace ProjetoWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d3 = new Department(3, "RH");
            Department d4 = new Department(4, "Finance");

            Seller s1 = new Seller() { Id = 1, Name = "Jorgin", Email = "jorgin@gmail.com", BirthDate = new DateTime(1998, 4, 21), BaseSalary = 1000.0, Department = d1 };
            Seller s2 = new Seller(2, "Luiz", "luiz@gamil.com", new DateTime(1995, 5, 17), 1500.0, d2);
            Seller s3 = new Seller(3, "Monique", "monique@gamil.com", new DateTime(2000, 7, 20), 1400.0, d3);
            Seller s4 = new Seller(4, "Pedro", "pedro@gamil.com", new DateTime(1989, 2, 7), 2000.0, d4);
            Seller s5 = new Seller(5, "Paula", "paula@gamil.com", new DateTime(1997, 6, 30), 3500.0, d4);
            Seller s6 = new Seller(6, "Beatriz", "beatriz@gamil.com", new DateTime(1992, 9, 27), 900.0, d2);
